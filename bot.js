...
function respond() {
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    this.res.writeHead(200);
    postMessage("https://www.instagram.com/p/B4Yh6_Gh_3k/");
    this.res.end();
  } 
    ...
    postMessage("http://daddyleagues.com/sfl21/team/"+request.text.substring(5,8)+"/depthchart");
    this.res.end();
  } 
    ...
    postMessage("http://daddyleagues.com/sfl21/team/"+request.text.substring(5,8)+"/schedule");
    this.res.end();
  }
